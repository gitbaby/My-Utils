		...
		if (id != null) {
			try {
				...
				if (rec != null) {
					...
					request.setAttribute("name", My.escapeHtml(rec.getName()));
					request.setAttribute("addressLine1", My.escapeHtml(rec.getAddressLine1()));
					request.setAttribute("addressLine2", My.escapeHtml(rec.getAddressLine2()));
					request.setAttribute("city", My.escapeHtml(rec.getCity()));
					request.setAttribute("country", My.escapeHtml(rec.getCountry()));
					request.setAttribute("state", My.escapeHtml(rec.getState()));
					request.setAttribute("postCode", My.escapeHtml(rec.getPostCode()));
				}
